  ...
  <div className="relative min-h-screen overflow-hidden text-gray-900 dark:text-white transition-colors duration-300">
    ...
    <div className="relative z-10 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Header Card */}
        <header className="flex items-center justify-between p-6 bg-white/85 dark:bg-gray-900/75 backdrop-blur-xl rounded-3xl border border-white/30 dark:border-gray-700 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.4)]">
